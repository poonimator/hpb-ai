      ...
      <div className="flex-1 min-h-0 w-full overflow-y-auto bg-[color:var(--canvas)]">
        <div className="max-w-[720px] mx-auto px-6 pt-10 pb-20">
          <header className="mb-10">
            ...
            <h1 className="text-display-2 text-foreground leading-tight mt-2">Privacy Statement</h1>
            <p className="text-body-sm text-muted-foreground mt-2">Last updated: April 2026</p>
          </header>
          ...
          <article className="flex flex-col gap-8 text-body text-foreground">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">The Application processes the following types of information:</p>
              <div className="flex flex-col gap-4">
                <div>
                  <h3 className="text-ui font-semibold text-foreground mb-2">User-provided content</h3>
                ...
                <div>
                  <h3 className="text-ui font-semibold text-foreground mb-2">Automatically collected data</h3>
                  <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">Information processed through the Application is used for:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">We implement appropriate security measures to protect your information:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">The Application integrates with the following third-party AI service:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">Data is retained in accordance with HPB&apos;s records management policies:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">As a user of this Application, you have the following rights regarding your data:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">When using AI features, please be aware:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body">This Application may use browser cookies and local storage for:</p>
              <ul className="list-disc list-inside text-body space-y-2">
            ...
            <section className="flex flex-col gap-3">
              ...
              <p className="text-body-sm text-muted-foreground italic mt-4">
